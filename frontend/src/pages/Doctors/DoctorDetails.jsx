      ...
      <div className="max-w-[1170px] px-5 mx-auto">
        <div className="grid md:grid-cols-3 gap-[50px]">
          <div className="md:col-span-2">
            <div className="flex items-center gap-5">
              ...
              <div>
                ...
                <p className="text_para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]">
                  Head of Gastrointestinal Surgery Department, Center for
                  Endoscopy and Gastrointestinal Surgery, Tam Anh General
            ...
            <div className="mt-[50px] border-b border-soild border-[#0066ff34]">
              <button
